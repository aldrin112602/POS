...
import { ArrowUpDown, CheckIcon, Filter, Search, ShoppingCart, Star } from 'lucide-react';
                            ...
                            >
                                ...
                                <div className="flex flex-1 flex-col p-4">
                                    ...
                                    <div className="mt-auto flex items-center justify-between pt-4">
                                        ...
                                        <button className="px-3 rounded-lg bg-purple-600 py-2 text-sm font-medium text-white hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-800 flex items-center justify-center gap-2">
