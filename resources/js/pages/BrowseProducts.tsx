...
import { Search, Filter, ArrowUpDown, Star, CheckIcon } from 'lucide-react';
import { 
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
export default function BrowseProducts() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className={`flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950 transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <div className="flex flex-col gap-3 md:flex-row md:items-center">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-300 bg-white px-10 py-2 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                            />
                        </div>
                        
                        {/* Category Filter - Using DropdownMenu */}
                        <DropdownMenu>
                            <DropdownMenuTrigger className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-2 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                ...
                {products.length > 0 ? (
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {products.map((product) => (
                            <div 
                                key={product.id}
                                className="group relative flex flex-col overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-800 transform hover:scale-[1.02]"
                            >
                                ...
                                <div className="absolute right-2 top-2 rounded-full bg-white px-2 py-1 font-medium text-xs shadow dark:bg-gray-900">
                                ...
                                <div className="flex flex-1 flex-col p-4">
                                    ...
                                    <div className="mt-auto flex items-center justify-between pt-4">
                                        ...
                                        <button className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                            Add to Cart
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className="flex h-40 items-center justify-center rounded-xl bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm">
